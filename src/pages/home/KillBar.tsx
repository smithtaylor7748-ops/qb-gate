...
import { Bullet, ConfirmDialog, Pill, Row, useToast, EVIDENCE_LABEL } from '../../ui';
...
export default function KillBar() {
  ...
  return (
    <>
      <button type="button" className="killbar mt-1" disabled={busy} onClick={previewKill}>
      ...
      <p className="notice notice--danger text-center">
        ...
        收完会重新上锁，<strong>但你原来的租约会还给你</strong>（出口 IP 仍合格的话）。
